            ...
            <div id="sidebar"  class="nav-collapse ">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu">
                     ...
                     <ul class="sub">
                        <li><a href="{{ route('admin.game.create') }}">Create Game</a></li>
                        <li><a href="{{ route('admin.game.index') }}">List Game</a></li>
                     </ul>
                  </li>
                  <li class="sub-menu">
                     <a href="#" class="">
                     ...
                     <ul class="sub">
                        <li><a class="" href="{{ route('admin.system.create')}}">Create System</a></li>
